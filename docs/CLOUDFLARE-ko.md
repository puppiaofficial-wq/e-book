...
1. 왼쪽 메뉴 **Compute (Workers)** 또는 **Workers & Pages**
2. 오른쪽 위 **Create**
3. 위쪽 탭 **Pages**
4. 맨 아래 **Upload assets** 의 **Get started**

> **Connect to Git** 버튼이 크게 보이지만 그건 개발자용입니다. **Upload assets** 쪽입니다.

### 7. 이름 정하고 zip 끌어다 놓기

프로젝트 이름을 영문 소문자로 짧게 정합니다. 예) `puppia-catalog`
이 이름이 그대로 주소가 되니 한 번에 정하세요.
